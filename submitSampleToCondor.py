...
os.system("tar -cvzf {0} ./ --exclude 'plots*' --exclude '.git' --exclude 'test*' --exclude 'submitOneFile_' --exclude '*.tar.gz' --exclude 'ttbar*' --exclude '*-18' --exclude '*2018' --exclude 'MET*' --exclude 'single*' --exclude 'pass*' --exclude 'quick*'".format(tarball_name))
